...
export default function Reviews() {
    ...
    if (isTouchDevice === null) {
        return (
            <>
            <h2 className="text-6xl md:text-5xl lg:text-6xl w-full px-4 sm:px-8 lg:px-10 font-trajan text-left font-semibold mb-6 sm:mb-8 lg:mb-10">What Our Guests Say</h2>
    ...
    return (
        <>
        <h2 className="text-6xl sm:text-4xl md:text-5xl lg:text-6xl w-full px-8 sm:px-8 lg:px-10 font-trajan text-left font-semibold mb-6 sm:mb-8 lg:mb-10">What Our Guests Say</h2>
